...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    // Uses the given events array to  <tbody> elements that should be appended to each row's content skeleton.
...
var DayGridFillRenderer = /** @class */ (function (_super) {
    ...
    // s the HTML needed for one row of a fill. Requires the seg's el to be rendered.
...
var DayGrid = /** @class */ (function (_super) {
    ...
    // s the HTML for a single row, which is a div that wraps a table.
    ...
    // s the HTML for the <td>s of the "number" row in the DayGrid's content skeleton.
    ...
    // s the text that should be inside a "more" link, given the number of events it represents
...
var AbstractDayGridView = /** @class */ (function (_super) {
    ...
    function AbstractDayGridView() {
        ...
        /* Header Rendering
        ------------------------------------------------------------------------------------------------------------------*/
        // s the HTML that will go before the day-of week header cells
        ...
        /* Day Grid Rendering
        ------------------------------------------------------------------------------------------------------------------*/
        // s the HTML that will go before content-skeleton cells that display the day/week numbers
        ...
        // s the HTML that goes before the day bg cells for each day-row
        ...
        // s the HTML that goes before every other type of row d by DayGrid.
    ...
    // s an HTML attribute string for setting the width of the week number column, if it is known
